function player(scene, rockMap, l){
    ...
    const torsoMat = new THREE.MeshPhongMaterial({color: 0x667788});
    ...
    const frontg = new THREE.BoxGeometry(1,1,1);
    const frontm = new THREE.MeshPhongMaterial({color:0x334455});
    const front = new THREE.Mesh(frontg, frontm);
    front.position.set(2,0,-2);
    torso.add(front);

    const lowerGeo = new THREE.CylinderGeometry(1.5, 0.5, 1.0, 4);
    const lowerMat = new THREE.MeshPhongMaterial({color: 0x555555});
    ...
    const leftJunclMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const upperLegLeftBMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const upperLegLeftMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const leftKneeMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const lowerLegLeftBMat = new THREE.MeshPhongMaterial({color: 0x678678});
    ...
    const lowerLegLeftMat = new THREE.MeshPhongMaterial({color: 0x678678});
    ...
    const leftFootMat = new THREE.MeshPhongMaterial({color: 0x876876});
    ...
    const rightJunclMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const upperLegRightBMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const upperLegRightMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const rightKneeMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const lowerLegRightBMat = new THREE.MeshPhongMaterial({color: 0x678678});
    ...
    const lowerLegRightMat = new THREE.MeshPhongMaterial({color: 0x678678});
    ...
    const rightFootMat = new THREE.MeshPhongMaterial({color: 0x876876});
    ...
    const rightShoulMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const upperArmRightBMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const upperArmRightMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const rightElbMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const lowerArmRightMat = new THREE.MeshPhongMaterial({color: 0x678678});
    ...
    const rightHandMat = new THREE.MeshPhongMaterial({color: 0x554455});
    ...
    const leftShoulMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const upperArmLeftBMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const upperArmLeftMat = new THREE.MeshPhongMaterial({color: 0x887766});
    ...
    const leftElbMat = new THREE.MeshPhongMaterial({color: 0x776688});
    ...
    const lowerArmLeftMat = new THREE.MeshPhongMaterial({color: 0x678678});
    ...
    const leftHandMat = new THREE.MeshPhongMaterial({color: 0x554455});
...
//---------------------------------------------------------------------------------------------------------------------------------
    ...
    const neckMat = new THREE.MeshPhongMaterial({color: 0x955559});
    ...
    const headMat = new THREE.MeshPhongMaterial(0x947947);
